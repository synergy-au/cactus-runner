...
class ResourceAnnotations:
    ...
    tariff_profile_ids_by_alias: dict[str, str] = field(default_factory=dict)
    rate_component_ids_by_alias: dict[str, str] = field(default_factory=dict)
    time_tariff_interval_ids_by_alias: dict[str, str] = field(default_factory=dict)
